...
#ifndef TCPDEVICEDETECT_H
#define TCPDEVICEDETECT_H
...
class TcpDeviceDetect
	:public QObject
{
	Q_OBJECT
public:
	explicit TcpDeviceDetect(QObject *parent=0);
...
private:
	TcpDeviceDetectServer srv;
	QUdpSocket bCastSock;
	QByteArray bCastMsg;
	QTimer tmr;
};

#endif // TCPDEVICEDETECT_H
