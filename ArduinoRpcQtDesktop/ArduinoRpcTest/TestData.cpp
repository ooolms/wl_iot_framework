...
const QVector<float> singleData1={12.0,621.124,2845.125626};
...
const QVector<float> singleData2={12.0,715.14,34.11};
...
const QVector<float> packetData1F={12.0,621.124,2845.125626,156.6,124.1,0.1};
...
const QVector<float> packetData1Sample0F={12.0,621.124,2845.125626};
const QVector<float> packetData1Sample1F={156.6,124.1,0.1};
