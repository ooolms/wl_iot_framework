...
ARpcDBDriverFixedBlocksTests::ARpcDBDriverFixedBlocksTests(QObject *parent)
	:QtUnitTestSet("ARpcDBDriverFixedBlocksTest",parent)
{
	addTest((TestFunction)&ARpcDBDriverFixedBlocksTests::testCreateAndOpen,"Test create database and open it");
	addTest((TestFunction)&ARpcDBDriverFixedBlocksTests::testReadWriteWholeBlock,"Test read/write whole block");
	addTest((TestFunction)&ARpcDBDriverFixedBlocksTests::testReadWriteNote,"Test read/write note by note");
}

void ARpcDBDriverFixedBlocksTests::testCreateAndOpen()
{
...
void ARpcDBDriverFixedBlocksTests::testReadWriteWholeBlock()
{
	ARpcDBDriverFixedBlocks db;
	QFile(fileName).remove();
	VERIFY(db.create(fileName,sizes));
...
void ARpcDBDriverFixedBlocksTests::testReadWriteNote()
{
	ARpcDBDriverFixedBlocks db;
	QFile(fileName).remove();
	VERIFY(db.create(fileName,sizes));
