...
#ifndef SUBPROGRAMFAKEBLOCKSEDITORS_H
#define SUBPROGRAMFAKEBLOCKSEDITORS_H

#include "VDIL/editor/IBlockEditor.h"

namespace WLIOTVDIL
{
	class SubProgramInternalOutputsFakeBlockEditor
		:public IBlockEditor
	{
	public:
	...
	class SubProgramInternalInputsFakeBlockEditor
		:public IBlockEditor
	{
	public:
		virtual QString typeName()const override;
...
#endif // SUBPROGRAMFAKEBLOCKSEDITORS_H
