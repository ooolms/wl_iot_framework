...
TimerConfigEdit::~TimerConfigEdit()
{
	delete ui;
}

void TimerConfigEdit::setConfig(const TimerBlock::TimerConfig &cfg)
{
...
TimerBlock::TimerConfig TimerConfigEdit::config()
{
