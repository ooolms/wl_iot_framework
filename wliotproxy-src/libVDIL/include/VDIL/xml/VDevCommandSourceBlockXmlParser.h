...
#ifndef VDEVCOMMANDSOURCEBLOCKXMLPARSER_H
#define VDEVCOMMANDSOURCEBLOCKXMLPARSER_H

#include "VDIL/xml/IBlockXmlParser.h"

namespace WLIOTVDIL
{
	class VDevCommandSourceBlockXmlParser
...
#endif // VDEVCOMMANDSOURCEBLOCKXMLPARSER_H
