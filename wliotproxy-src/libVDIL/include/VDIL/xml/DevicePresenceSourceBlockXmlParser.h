...
#ifndef DEVICEPRESENCESOURCEBLOCKXMLPARSER_H
#define DEVICEPRESENCESOURCEBLOCKXMLPARSER_H

#include "VDIL/xml/IBlockXmlParser.h"

namespace WLIOTVDIL
{
	class DevicePresenceSourceBlockXmlParser
...
#endif // DEVICEPRESENCESOURCEBLOCKXMLPARSER_H
