...
static const QString jsonDescr=QString::fromUtf8(
	"{\"controls\":[{\"group\":\"group1\",\"layout\":\"h\",\"elements\":["
	"{\"control\":\"Light\",\"command\":\"light\",\"sync\":false,\"params\":["
	"{\"param\":\"Light switch\",\"type\":\"checkbox\",\"constraints\":{\"onValue\":\"1\",\"offValue\":\"0\"}}]},"
	"{\"control\":\"Heater\",\"command\":\"heater\",\"sync\":true,\"params\":["
	"{\"param\":\"Heater control\",\"type\":\"slider\",\"constraints\":{\"min\":\"0\",\"max\":\"100\"}}]}]},"
	"{\"control\":\"Reset\",\"command\":\"reset\",\"sync\":false}]}");

static const QString xmlDescr=QString::fromUtf8(
	"<controls><group title=\"Test controls set\"><group title=\"group1\" layout=\"h\">"
	"<command title=\"Light\" command=\"light\" sync=\"0\">"
	"<param title=\"Light switch\" type=\"checkbox\"><constraints onValue=\"1\" offValue=\"0\"/></param></command>"
	"<command title=\"Heater\" command=\"heater\" sync=\"1\">"
	"<param title=\"Heater control\" type=\"slider\"><constraints min=\"0\" max=\"100\"/></param></command>"
	"</group><command title=\"Reset\" command=\"reset\" sync=\"0\"/></group></controls>"
);
