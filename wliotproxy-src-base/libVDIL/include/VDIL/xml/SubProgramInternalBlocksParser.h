...
#ifndef SUBPROGRAMINTERNALBLOCKSPARSER_H
#define SUBPROGRAMINTERNALBLOCKSPARSER_H

#include "VDIL/xml/IBlockXmlParser.h"

namespace WLIOTVDIL
{
	class SubProgramInternalInputBlockXmlParser
	...
	class SubProgramInternalOutputBlockXmlParser
		:public IBlockXmlParser
	{
	public:
		virtual bool blockFromXml(BaseBlock *block, const QDomElement &blockElem,bool tryFixErrors) override;
...
#endif // SUBPROGRAMINTERNALBLOCKSPARSER_H
